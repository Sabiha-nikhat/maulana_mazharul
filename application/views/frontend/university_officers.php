                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>19-07-2023</td>
                                        <td><center><a href="school_of_computational_sciences_dean.php" class="resume-icon"><i class="fa fa-file-pdf-o"></i></a></center></td>
                                    </tr>
                                    <tr>
                                        <td>Education   </td>
                                        <td>Prof. Asheesh Srivastava,Dept. of Education </td>
                                        <td>07-09-2022</td>
                                        <td><center><a href="school_of_education_dean.php" class="resume-icon"><i class="fa fa-file-pdf-o"></i></a></center></td>
                                    </tr>
                                    <tr>
                                        <td>Humanities And Languages</td>
                                        <td>Prof. Prasoon Dutta Singh, Dept. of Sanskrit</td>
                                        <td>06-04-2022</td>
                                        <td><center><a href="school_of_Humanities_and_Languages_dean.php" class="resume-icon"><i class="fa fa-file-pdf-o"></i></a></center></td>
                                    </tr>
                                    <tr>
                                        <td>Physical Sciences</td>
                                        <td>Prof. Devdutt Chaturvedi, Dept. of Chemistry</td>
                                        <td>30-08-2022</td>
                                        <td><center><a href="school_of_physical_sciences_dean.php" class="resume-icon"><i class="fa fa-file-pdf-o"></i></a></center></td>
                                    </tr>
                                    <tr>
                                        <td>Social Sciences</td>
                                        <td>Prof. Sunil Mahawar, Dept. of Gandhian and Peace Studies</td>
                                        <td>11-09-2022</td>
                                        <td><center><a href="school_of_social_sciences_dean.php" class="resume-icon"><i class="fa fa-file-pdf-o"></i></a></center></td>
                                    </tr> 
