    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a href="index.php">Home </a><span class="lnr lnr-arrow-right"></span> <a href=""> About</a><span class="lnr lnr-arrow-right"></span> <a href="" class="orange-text"> Vice Chancellor</a></p>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="detials">
                        <div class="desc-wrap marquee_text">
                            <div class="whiteBox" style="float: none;">
                                <img src="<?php echo base_url(); ?>images/vc.jpg" alt="Prof. Sanjay Srivastava" class="img img-responsive" style="width: 300px;">
                                <div class="vcBox-content text-justify">
                                    ...
                                    <h5>Mahatma Gandhi Central University, Bihar</h5>
                                    <br/>
                                    <p class="text-justify">Before joining MGCU, Motihari, as its Vice Chancellor, Prof. Sanjay Srivastava was
                                        Professor at Political Science department of Banaras Hindu University. He taught
                                        international relations and his research interests include India’s foreign policy,
                                        conflict resolution and peace, and Indian politics. He also took part in curriculum
                                        development, research supervision and administrative activities of the university.</p>
                                    <p class="text-justify">Prof. Srivastava was a Fulbright Visiting scholar at the School of Communication,
                                        American University, Washington D.C (during 2016-17). In 2018, hon’ble President
                                        of India nominated Prof. Srivastava on the BHU Court (the highest advisory body of
                                        the Banaras Hindu University, 2018-21).</p>
                                    <p class="text-justify">In 2022, hon’ble President of India nominated Prof. Srivastava as his nominee on
                                        the Executive Council of Jamia Millia Islamia, New Delhi. He is also on the Finance
                                        ...
                                        Information Cell.</p>
                                    <p class="text-justify">Prof. Srivastava was ICCR Chair of Contemporary Indian Studies at Yerevan State
                                        University, Armenia (2013-14), where he was involved in public diplomacy (PD)
                                        activities of the Indian embassy and delivered lectures on various issues including
                                        ...
                                        annual conference in Baltimore (MD) in 2017. The IIE organized his lectures at the
                                        ...
                                        has led many major research projects; the recent one is on evaluating effectiveness
                                        of public diplomacy programs of India, a first research of its type using
                                        experimental research design.</p>
                                    <p class="text-justify">Prof. Srivastava was awarded UGC’s Career Award (Research Award) (2004) given
                                        ...
                                        published on issues of international relations in various compendiums and national
