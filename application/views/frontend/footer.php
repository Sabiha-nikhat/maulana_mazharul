 <div class="clearfix"></div>
            ...
            <div class="row">
               ...
               <div class="col-md-4 col-xs-12 text-center">
                  <ul class="middleLinks">
                     ...
                     <li><a href="<?php echo base_url(); ?>frontend/website_policy">Policy</a></li>
                  </ul>
               </div>
               ...
               <div class="col-md-2 col-xs-12">
                  <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-gray-lighter p-8">
                     ...
                     <h4 class="icon-box-title text-uppercase mt-15">
                        <a href="<?php echo base_url(); ?>frontend/gallery_thum">Photo Gallery</a>
                     </h4>
                  </div>
                  <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-gray-lighter p-8">
                  ...
                  <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-gray-lighter p-8">
                     ...
                     <h4 class="icon-box-title text-uppercase font-18 mt-15">
                        <a href="<?php echo base_url(); ?>frontend/newspaper_clippings">News Paper Clippings</a>
                     </h4>
                  </div>
                  <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-gray-lighter p-8">
                     ...
                     <h4 class="icon-box-title text-uppercase font-18 mt-15">
                        <a href="<?php echo base_url(); ?>frontend/directory">Directory</a>
                     </h4>
                  </div>
                  <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-gray-lighter p-8">
                     ...
                     <h4 class="icon-box-title text-uppercase font-18 mt-15">
                        <a href="<?php echo base_url(); ?>frontend/tender">Tenders</a>
                     </h4>
                  </div>
                  <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-gray-lighter p-8">
               ...
               <div class="col-md-3 col-xs-12">
                  <div class="row imp_logos">
                     ...
                     <div class="col-md-6 col-xs-12 plr-5">
                        <a href="https://www.education.gov.in/en" target="_blank"><img src="<?php echo base_url(); ?>images/imp_logos/01.png" class="img-responsive"></a>
                     </div>
                     <div class="col-md-6 col-xs-12 plr-5">
                        <a href="https://www.ugc.ac.in/" target="_blank"><img src="<?php echo base_url(); ?>images/imp_logos/02.png" class="img-responsive"></a>
                     </div>
                     <div class="col-md-6 col-xs-12 plr-5">
                        <a href="http://naac.gov.in/index.php/en/" target="_blank"><img src="<?php echo base_url(); ?>images/imp_logos/03.png" class="img-responsive"></a>
                     </div>
                     <div class="col-md-6 col-xs-12 plr-5">
                        <a href="https://nad.ndml.in/" target="_blank"><img src="<?php echo base_url(); ?>images/imp_logos/04.png" class="img-responsive"></a>
                     </div>
                     <div class="col-md-6 col-xs-12 plr-5">
                        <a href="https://icssr.org/" target="_blank"><img src="<?php echo base_url(); ?>images/imp_logos/05.png" class="img-responsive"></a>
                     </div>
                     <div class="col-md-6 col-xs-12 plr-5">
                        <a href="https://scholarships.gov.in/" target="_blank"><img src="<?php echo base_url(); ?>images/imp_logos/06.png" class="img-responsive"></a>
                     </div>
                     <div class="col-md-6 col-xs-12 plr-5">
                        <a href="https://nta.ac.in/" target="_blank"><img src="<?php echo base_url(); ?>images/imp_logos/07.png" class="img-responsive"></a>
                     </div>
                     <div class="col-md-6 col-xs-12 plr-5">
                        <a href="https://www.vidyalakshmi.co.in/" target="_blank"><img src="<?php echo base_url(); ?>images/imp_logos/08.png" class="img-responsive"></a>
                     </div>
                     <div class="col-md-6 col-xs-12 plr-5">
                        <a href="https://delnet.in/" target="_blank"><img src="<?php echo base_url(); ?>images/imp_logos/09.png" class="img-responsive"></a>
                     </div>
                     <div class="col-md-6 col-xs-12 plr-5">
                        <a href="https://www.india.gov.in/" target="_blank"><img src="<?php echo base_url(); ?>images/imp_logos/10.png" class="img-responsive"></a>
                     </div>
                     <div class="col-md-6 col-xs-12 plr-5">
                        <a href="https://www.nirfindia.org/Home" target="_blank"><img src="<?php echo base_url(); ?>images/imp_logos/11.png" class="img-responsive"></a>
                     </div>
                     <div class="col-md-6 col-xs-12 plr-5">
                        <a href="https://www.ariia.gov.in/" target="_blank"><img src="<?php echo base_url(); ?>images/imp_logos/12.png" class="img-responsive"></a>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <script src="<?php echo base_url(); ?>js/vendor/jquery-3.7.min.js"></script>
